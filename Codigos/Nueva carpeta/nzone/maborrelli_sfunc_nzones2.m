function [sys,x0,str,ts,simStateCompliance]=maborrelli_sfunc_nzones2(t,x,u,flag,ic,params,ST)
...
[sys,~]=dynamics_hvac_maborrelli_singapur_nz2(x,u,params,ST);
