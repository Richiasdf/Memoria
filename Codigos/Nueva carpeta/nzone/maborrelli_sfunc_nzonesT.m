function [sys,x0,str,ts,simStateCompliance]=maborrelli_sfunc_nzonesT(t,x,u,flag,ic,params,ST)
...
[sys,~]=dynamics_hvac_maborrelli_singapur_T(x,u,params);

% end mdlDerivatives

function sys=mdlUpdate(x,u,params,ST)
[sys,~]=dynamics_hvac_maborrelli_singapur_T(x,u,params,ST);
