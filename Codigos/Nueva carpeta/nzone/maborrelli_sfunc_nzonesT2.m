function [sys,x0,str,ts,simStateCompliance]=maborrelli_sfunc_nzonesT2(t,x,u,flag,ic,params,ST)
...
sizes.NumDiscStates  = 2*nz;
sizes.NumOutputs     = 2*nz;
sizes.NumInputs      = nz*1+1+11;
...
[sys,~]=dynamics_hvac_maborrelli_singapur_T2(x,u,params);

% end mdlDerivatives

function sys=mdlUpdate(x,u,params,ST)
[sys,~]=dynamics_hvac_maborrelli_singapur_T2(x,u,params,ST);
