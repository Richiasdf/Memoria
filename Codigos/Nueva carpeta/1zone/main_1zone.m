...
device = "cpu";
%Save & Load options
save_agent_name = "train_agent.mat";
...
StopReward = 14; %Episode reward to stop learning
...
agentOpts.NoiseOptions.StandardDeviation = 0.5/sqrt(Ts2); %;0.3*sqrt(Ts2) ; 0.45 ; 0.1];
agentOpts.NoiseOptions.StandardDeviationDecayRate = 5e-4;% 5e-7; 3e-7 ;1e-7];
agentOpts.NoiseOptions.MeanAttractionConstant = 0.2/Ts2;
agentOpts.NoiseOptions.StandardDeviationMin = 0.005/sqrt(Ts2);% 0.1; 0.03 ;0.05];
