...
%rangos continuos
obsInfo = rlNumericSpec([1 1], 'LowerLimit', -20, 'UpperLimit', 40);
...
actInfo = rlNumericSpec([2 1], 'LowerLimit', [-30;0] , 'UpperLimit', [0;0.9]);
...
env = rlSimulinkEnv(mdl2,'hvac_1zone_2v/RL Agent',...
    obsInfo,actInfo);
...
actionPath = [
    ...
    fullyConnectedLayer(6,'Name','CriticActionFC3')];
commonPath = [
...
actorNetwork = [
    featureInputLayer(numObservations,'Normalization','none','Name','State')
    fullyConnectedLayer(4, 'Name','actorFC2')
